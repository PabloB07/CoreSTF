package live.imcoding.supertabulator.backpack;

import live.imcoding.supertabulator.utils.Base64;
...
public class Backpack {
    ...
    public Backpack(UUID uuid) {
        this.uuid = uuid;
        this.inventory = Bukkit.createInventory(null, 27 /* multiplo de 9 */, HexColor.format("#536e16Mochila"));
    }
